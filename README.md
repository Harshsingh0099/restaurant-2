This project is a simple restaurant order management web application using Flask and MySQL. It allows customers to view the menu, place an order, and see an order confirmation page.
Features
